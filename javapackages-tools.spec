...
Requires:       %{?scl_prefix}xmvn-minimal
Requires:       %{?scl_prefix}xmvn-mojo
Requires:       %{?scl_prefix}xmvn-connector-aether
...
Requires:       %{?scl_prefix}xmvn-connector-ivy
...
Requires:       %{name} = %{version}-%{release}
Requires:       %{?scl_prefix}xmvn-install
Requires:       %{?scl_prefix}xmvn-subst
Requires:       %{?scl_prefix}xmvn-resolve
...
* Wed Jun 21 2017 Java Maintainers <java-maint@redhat.com> - 5.0.0-2.1
...
- Generate maven-files-%%{pkg_name} with a list of files to package
